...
const (
	secretsMountPath = "/var/faas/secrets"
)
...
func (r *FunctionReconciler) UpdateSecrets(function *faasv1alpha1.Function, deployment *appsv1.Deployment, existingSecrets map[string]*corev1.Secret) error {
