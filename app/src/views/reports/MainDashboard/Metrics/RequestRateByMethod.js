...
const RequestRateByMethod = ({ functionId, endTime, range, width }) => {
  ...
  const buildChart = (series) => {
    return {
      ...
      options: {
        ...
        title: {
          text: "Request Rate by Method (per second)",
          align: "center"
        },
        theme: {
...
RequestRateByMethod.prototype = {
  className: PropTypes.string,
  functionId: PropTypes.string.isRequired
}

export default RequestRateByMethod;